	...
	<table class="table responsive-table" id="sorting-example1">
		<thead>
			<tr>
				...
				<th scope="col" width="15%" class="align-center hide-on-mobile"><?php echo lang('user_joined_label');?></th>
				<th scope="col" width="15%" class="align-center hide-on-mobile-portrait"><?php echo lang('user_last_visit_label');?></th>
				<th scope="col" width="60" class="align-center"></th>
			</tr>
		</thead>
		<tfoot>
			<tr>
