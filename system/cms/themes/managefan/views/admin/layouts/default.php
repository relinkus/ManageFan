...
<head>
	...
	<!-- For all browsers -->
	<?php Asset::css('reset.css'); ?>
	<?php Asset::css('style.css'); ?>
	<?php Asset::css('colors.css'); ?>
	<?php Asset::css('print.css'); ?>
	<!-- For progressively larger displays -->
	<?php Asset::css('480.css'); ?>
	<?php Asset::css('768.css'); ?>
	<?php Asset::css('992.css'); ?>
	<?php Asset::css('1200.css'); ?>
	<!-- For Retina displays -->
	<?php Asset::css('2x.css'); ?>
	<!-- Additional styles -->
	<?php Asset::css('styles/form.css'); ?>
	<?php Asset::css('styles/switches.css'); ?>
	<?php Asset::css('styles/agenda.css'); ?>
	<?php Asset::css('styles/dashboard.css'); ?>
	<?php Asset::css('styles/modal.css'); ?>
	<?php Asset::css('styles/progress-slider.css'); ?>
	<!-- Login pages styles -->	
