<ul id="shortcuts" class="children-tooltip tooltip-right">
	...
	<?php endif; ?>
	<?php if (array_key_exists('sample', $this->permissions) OR $this->current_user->group == 'admin'): ?>
	<?php echo '<li class="'.(($this->module == 'sample' ? 'current' : '')) .'">';
			 echo anchor('admin/sample', lang('cp_nav_sample'),'class="shortcut-settings"');?></li>
	<?php endif; ?>
