...
#social_networks { margin: 0; padding: 0; }
#social_networks li { width: 270px; margin:0 10px 10px 0; background: #bbb; list-style: none; border-radius: 8px; }
#social_networks li a { display:block; color: #fff; padding:20px 0; padding-left: 25px; font-size: 18px; font-weight: bold; }

#social_networks li.facebook { background: rgb(47,73,132); } 
#social_networks li.twitter { background: rgb(51,156,234); } 
#social_networks li.google { background: rgb(215,43,34); } 
#social_networks li.live { background: rgb(232,140,45); } 
#social_networks li.linkedin { background: rgb(46,128,183); }
...
<div class="with-padding users">
	<div class="columns">
		<div class="new-row twelve-columns">
			<p>link your accounts in the different social networks to sart using managefan!</p>
		</div>
		<div class="six-columns twelve-columns-tablet">
			...
			<pre>
				...
				<li class="live"><a href="#">+ Windows Live</a></li>
